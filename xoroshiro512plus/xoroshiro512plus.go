...
// XoroShiro512Plus holds the state required by XoroShiro512Plus generator
type XoroShiro512Plus struct {
...
// NewSource return a new XoroShiro512Plus random number generator
func NewSource(seed int64) *XoroShiro512Plus {
	tmpxs := XoroShiro512Plus{}
	tmpxs.Seed(seed)
	return &tmpxs
}

// Seed use the provvided seed value to init XoroShiro512Plus internal state.
func (x *XoroShiro512Plus) Seed(seed int64) {
...
func (x *XoroShiro512Plus) Uint64() uint64 {
